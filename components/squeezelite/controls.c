...
now_playing_2			= 7689a25d
search_2				= 7689629d
favorites_2				= 7689e21d
...
digital_input_aes-ebu		= 768906f9
digital_input_bnc-spdif		= 76898679
digital_input_rca-spdif		= 768946b9
digital_input_toslink		= 7689c639

analog_input_line_in		= 76890ef1
...
static void sendIR(u16_t addr, u16_t cmd) {
    ...
    if ((cmd & 0xFFFF) == 0xB847){
	    LOG_INFO("substituting size for sleep button");
        cmd = (0xF807);
    }
